...
Note that Atlas Node Rewards are distributed over the timeframe of 1 year to incentivise keeping bundles available for the network. Similarly Apollo Bundle Rewards are not equally distributed every day, but over a longer time period. See Payout-Scheme for Atlas Nodes below:
