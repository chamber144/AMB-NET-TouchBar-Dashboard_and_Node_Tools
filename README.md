...
Here I present a complete setup that may help you monitor and control your single or multiple ATLAS or APOLLO node(s) through the MacBook TouchBar _(New Stats Dashboard options with combined information of multiple nodes introduced in version 1.5)_.
