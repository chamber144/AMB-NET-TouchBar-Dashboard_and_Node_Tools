...
just open it and import the newest __AMB_Dashboard*.bbtpreset__ file that I have put up here for download by using the preset function in the top right corner and click on import.
...
And if you like this project and find it useful, here is my tip jar that gratefully accepts AMB or ETH:
